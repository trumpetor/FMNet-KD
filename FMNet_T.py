...
from COA_RGBD_SOD.al.models.Second_model.module_T import Decoder, block, block4
...
class CoNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_RGB = p2t_large()
        self.conv_depth = p2t_large()
        self.channels = [64, 128, 320, 640]
    ...
    def forward(self, x, depth):
        ...
        F = self.decoder2(f4, fusion3, fusion2, fusion1, fusion1)
        F = self.conv64(self.up4(F))
        F1 = self.conv64_1(self.up4(fusion1))
